  ...
  return (
    <div className="post rounded-lg p-2 m-2 tb:w-52 lg-tb:w-52 lp:w-sm lg-lp:w-xs hover:cursor-pointer">
      <div className="card shadow-sm dark:bg-accent-content rounded-lg">
        <figure>
          <Image src="https://images.pexels.com/photos/33020130/pexels-photo-33020130.jpeg" alt="Post Image" height={2000} width={2000} className="object-cover h-full w-full relative rounded-lg" />
